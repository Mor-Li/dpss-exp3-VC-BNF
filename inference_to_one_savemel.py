...
def main():
    ...
    predicted_mel_plot_path = os.path.join(args.save_dir, f"{wav_name}-predicted-mel.png")
    save_mel_plot(predicted_mels, predicted_mel_plot_path, title="Predicted Mel-Spectrogram")

    # Save ground truth Mel-spectrogram
    groundtruth_mel_plot_path = os.path.join(args.save_dir, f"{wav_name}-groundtruth-mel.png")
    save_mel_plot(mel_spec, groundtruth_mel_plot_path, title="Ground Truth Mel-Spectrogram")
